...
URL = 'https://backpack.tf/stats/Strange/' + weaponName + '/Tradable/Craftable/0'
...
print(soup.find(title="Strange " + weaponName)['data-p_bptf_all']) #Backpack.tf price
print(soup.find(title="Strange " + weaponName)['data-p_scm']) #Steam market price
